...
Cada grupo prepara uma pergunta sobre outro tema, conforme a tabela a seguir.

## Temas e perguntas {.smaller}

| Grupo | Tema | Pergunta ao grupo |
|--:|---|--:|
| 1 | Processadores x86 e ARM | 8 |
| 2 | Processadores com vários núcleos | 9 |
| 3 | Microcontroladores | 10 |
| 4 | Memória principal DDR4 ou DDR5 | 1 |
| 5 | Memória cache | 2 |
| 6 | Disco magnético e SSD SATA | 3 |
| 7 | SSD NVMe e PCI Express | 4 |
| 8 | USB e USB-C | 5 |
| 9 | HDMI e DisplayPort | 6 |
| 10 | Ethernet | 7 |

A pergunta pede explicação ou comparação, não uma sigla ou um número.
...
grupo expõe por seis minutos. Nos dois seguintes, o grupo designado pergunta e o
grupo que apresentou responde.
...
- Encontro 4: no tempo restante da aula, sorteio, planejamento e início do
  trabalho em grupo.
- Entre os encontros 4 e 5: pesquisa e produção em grupo.
- Encontro 5: apresentações, com seis minutos por grupo mais dois de pergunta e
  resposta, e síntese da turma.
