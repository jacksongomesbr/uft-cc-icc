...
A @tbl-periodos apresenta a divisão de períodos que este capítulo segue, na
forma da transformação dominante de cada um. Ela serve de mapa para as seções
seguintes, e vale voltar a ela quando um marco parecer solto.

| **Período** | **Transformação dominante** |
|---|---|
| Até 1622 | Contar e calcular por representações externas ao corpo |
| Séculos XVII a XIX | Mecanizar a operação aritmética e controlar máquina por cartões |
| 1830 a 1900 | Unir lógica, telecomunicação e processamento de dados |
| 1900 a 1940 | Preparar eletrônica, memória e organizações de informação |
| 1936 a 1950 | Formalizar a computação e construir os primeiros computadores |
| Anos 1950 | Transistor, linguagens de programação e sistemas operacionais |
| Anos 1960 | Circuitos integrados, interação e redes experimentais |
| Anos 1970 | Microprocessador, computador pessoal e plataformas de software |
| Anos 1980 | Padronização do computador pessoal e interconexão crescente |
| Anos 1990 | Web, mecanismos de busca e serviços online |
| Anos 2000 | Plataformas participativas, smartphones e computação móvel |

: Períodos da história da computação e a transformação dominante de cada um, conforme @wazlawick2016. {#tbl-periodos}
...
A Máquina Analítica separa quatro funções, apresentadas na @tbl-babbage-funcoes
com os nomes que Babbage usou.

| **Função** | **Nome de Babbage** | **Papel no projeto** |
|---|---|---|
| Memória | store | Guarda números e resultados intermediários |
| Processamento | mill | Executa as operações aritméticas |
| Entrada e controle | cartões | Fornece os dados e a sequência de operações |
| Saída | impressão | Torna o resultado utilizável fora da máquina |

: As quatro funções da Máquina Analítica de Babbage. {#tbl-babbage-funcoes}
...
que a @tbl-babbage-funcoes já anunciou no século XIX.
