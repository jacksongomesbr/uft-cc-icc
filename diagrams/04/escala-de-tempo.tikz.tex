...
% um ciclo do processador como um segundo, e é o que torna a diferença
% perceptível.
...
\begin{tikzpicture}
  ...
  \nivel{0.17}{0.9}{procborda}{Registrador}{um ciclo do processador}{1 segundo}
  ...
  \node[rotulo peq, anchor=west, font=\footnotesize\bfseries] at (-0.2, 7.1)
    {Se um ciclo do processador durasse um segundo};
